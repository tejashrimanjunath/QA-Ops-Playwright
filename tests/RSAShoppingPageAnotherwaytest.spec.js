...
test("RSA HomePage Test", async ({ page }) => {
    ...
    //checkout page
    const checkoutCountry = page.getByPlaceholder("Select Country");
    ...
    //confirmation Page
    const confirmMsg = page.getByText("Thankyou for the order.");
    ...
    await page.locator(".card-body").filter({hasText:prodName})
