//This class is to explain another way of login other than token
...
test.beforeAll(async ({ browser }) => {
    ...
    //settings applied should be at browser level hence use context not page.
...
test("@API RSA HomePage Storage State API Test", async () => {
